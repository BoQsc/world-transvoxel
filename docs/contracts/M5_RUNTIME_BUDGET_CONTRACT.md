...
pacing. Those remain separate M5 measurements.
...
- content-addressed page I/O and decode latency under cache hit/miss pressure;
- real MIT-backed chunk sample/mesh throughput and seam-preserving workload;
