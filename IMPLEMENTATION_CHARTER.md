...
Within that physics-boundary lane, collision payloads generated by a committed
edit precede predictive player-support payloads. Both classes retain the same
bounded shape-application and time budgets; this changes ordering rather than
work admitted per physics step.
