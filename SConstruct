...
m2_mesh_test = native_test_env.Program(
    ...
    source=[
        ...
        "addons/world_transvoxel/src/backend/wt_transvoxel_mit_backend.cpp",
		"addons/world_transvoxel/src/core/wt_chunk_key.cpp",
		"addons/world_transvoxel/src/diagnostics/wt_gpu_meshing_differential_backend.cpp",
...
m5_async_storage_test = native_test_env.Program(
    ...
    source=[
        ...
        "addons/world_transvoxel/src/storage/wt_async_storage_service_worker.cpp",
...
m5_page_meshing_runtime_test = native_test_env.Program(
    os.path.join(
        "build",
        "native-tests",
        "test_wt_m5_page_meshing_runtime.{}.{}{}".format(
            env["target"],
            env["arch"],
            ".exe" if env["platform"] == "windows" else "",
        ),
    ...
    source=[
        ...
        "addons/world_transvoxel/src/services/wt_page_meshing_runtime_execution.cpp",
        "addons/world_transvoxel/src/services/wt_page_meshing_runtime_storage.cpp",
...
gpu_meshing_shadow_test = native_test_env.Program(
    os.path.join(
        "build",
        "native-tests",
        "test_wt_gpu_meshing_shadow.{}.{}{}".format(
            env["target"],
            env["arch"],
            ".exe" if env["platform"] == "windows" else "",
        ),
...
production_snapshot_query_test = native_test_env.Program(
    ...
    source=[
        ...
        "addons/world_transvoxel/src/storage/wt_world_snapshot_store_io.cpp",
...
production_read_only_runtime_sources = [
    ...
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime_completion.cpp",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime_demand.cpp",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime_edit.cpp",
	"addons/world_transvoxel/src/services/wt_read_only_world_runtime_foreground.cpp",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime_operations.cpp",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime_publication.cpp",
	...
	"addons/world_transvoxel/src/streaming/wt_foreground_priority.cpp",
    "addons/world_transvoxel/src/streaming/wt_lod_map.cpp",
    "addons/world_transvoxel/src/streaming/wt_multi_viewer_desired_set.cpp",
    "addons/world_transvoxel/src/streaming/wt_stream_scheduler.cpp",
	"addons/world_transvoxel/src/telemetry/wt_causal_trace.cpp",
...
production_streaming_test = native_test_env.Program(
    os.path.join(
        "build",
        "native-tests",
        "test_wt_production_streaming.{}.{}{}".format(
            env["target"],
            env["arch"],
            ".exe" if env["platform"] == "windows" else "",
        ),
