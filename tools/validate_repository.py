...
REQUIRED_FILES = (
    ...
    "scripts/test_m3.py",
    "scripts/test_m4.py",
    "scripts/test_m4_tools.py",
    "scripts/test_m4_bake_tool.py",
    "scripts/test_m5.py",
    "scripts/prepare_example_world.py",
    "scripts/build_release.py",
    "scripts/test_pq4.py",
    "tools/normalize_pe_timestamp.py",
    "tools/wt_storage.py",
    "tools/wt_bake.py",
    "tools/benchmark_m4_codec.py",
    "tools/benchmark_m5_runtime.py",
    "tools/benchmark_m5_pipeline.py",
    "tools/benchmark_m5_application.py",
    ...
    "tests/godot/m4_editor_bake_test.gd",
    "tests/godot/m4_editor_bake_test.gd.uid",
    "tests/godot/m5_application_budget.gd",
    "tests/godot/m5_application_budget.gd.uid",
    "tests/godot/production_config_test.gd",
    "tests/godot/production_config_test.gd.uid",
    "tests/godot/production_lifecycle_test.gd",
    "tests/godot/production_lifecycle_test.gd.uid",
    "tests/godot/production_streaming_test.gd",
    ...
    "tests/godot/production_chunk_query_test.gd.uid",
    "world_transvoxel/README.md",
    "world_transvoxel/example_config.tres",
    "world_transvoxel/example_viewer.gd",
    "world_transvoxel/example_viewer.gd.uid",
    "world_transvoxel/example_world.gd",
    "world_transvoxel/example_world.gd.uid",
    "world_transvoxel/example_world.tscn",
    "addons/world_transvoxel/LICENSE_SCOPE.md",
    "addons/world_transvoxel/README.md",
    "addons/world_transvoxel/PUBLIC_API.md",
    "addons/world_transvoxel/OPERATING_LIMITS.md",
    ...
    "addons/world_transvoxel/editor/world_transvoxel_bake_command.gd",
    "addons/world_transvoxel/editor/world_transvoxel_bake_command.gd.uid",
    "addons/world_transvoxel/tools/wt_bake.py",
    "addons/world_transvoxel/tools/wt_storage.py",
    ...
    "addons/world_transvoxel/src/api/world_transvoxel_terrain_lifecycle.cpp",
    ...
    "addons/world_transvoxel/src/api/world_transvoxel_chunk_state.h",
    "addons/world_transvoxel/src/api/world_transvoxel_config.cpp",
    "addons/world_transvoxel/src/api/world_transvoxel_config.h",
    ...
    "addons/world_transvoxel/src/bake/wt_dense_grid_source.h",
    "addons/world_transvoxel/src/bake/wt_snapshot_compactor.cpp",
    "addons/world_transvoxel/src/bake/wt_snapshot_compactor.h",
    ...
    "addons/world_transvoxel/src/editing/wt_edit_journal.h",
    "addons/world_transvoxel/src/editing/wt_chunk_edit_state.cpp",
    "addons/world_transvoxel/src/editing/wt_chunk_edit_state.h",
    "addons/world_transvoxel/src/editing/wt_edit_spatial_index.cpp",
    "addons/world_transvoxel/src/editing/wt_edit_spatial_index.h",
    ...
    "addons/world_transvoxel/src/services/wt_chunk_resource_cache.h",
    "addons/world_transvoxel/src/services/wt_chunk_resource_payload.cpp",
    "addons/world_transvoxel/src/services/wt_chunk_resource_payload.h",
    "addons/world_transvoxel/src/services/wt_desired_set_runtime.cpp",
    "addons/world_transvoxel/src/services/wt_desired_set_runtime.h",
    "addons/world_transvoxel/src/services/wt_edit_runtime_replacement.cpp",
    "addons/world_transvoxel/src/services/wt_edit_runtime_replacement.h",
    ...
    "addons/world_transvoxel/src/services/wt_page_meshing_runtime.h",
    "addons/world_transvoxel/src/services/wt_page_meshing_runtime_owner.h",
    "addons/world_transvoxel/src/services/wt_runtime_config.cpp",
    "addons/world_transvoxel/src/services/wt_runtime_config.h",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime.cpp",
    "addons/world_transvoxel/src/services/wt_read_only_world_runtime.h",
    ...
    "addons/world_transvoxel/src/storage/wt_async_storage_service.h",
    "addons/world_transvoxel/src/storage/wt_procedural_world_source.cpp",
    "addons/world_transvoxel/src/storage/wt_procedural_world_source.h",
    "addons/world_transvoxel/src/storage/wt_storage_page_cache.cpp",
    "addons/world_transvoxel/src/storage/wt_storage_page_cache.h",
    ...
    "addons/world_transvoxel/src/storage/wt_chunk_page_sample_source.h",
    ...
    "addons/world_transvoxel/src/telemetry/wt_determinism_trace.h",
    "addons/world_transvoxel/src/testing/wt_fault_injection.cpp",
    "addons/world_transvoxel/src/testing/wt_fault_injection.h",
    ...
    "addons/world_transvoxel/src/testing/wt_m5_application_benchmark_fixture.cpp",
    "addons/world_transvoxel/src/testing/wt_m5_application_benchmark_fixture.h",
    ...
    "addons/world_transvoxel/src/streaming/wt_balanced_lod_planner.h",
    "addons/world_transvoxel/src/streaming/wt_multi_viewer_desired_set.cpp",
    "addons/world_transvoxel/src/streaming/wt_multi_viewer_desired_set.h",
    ...
    "docs/contracts/FAULT_ORDER_DETERMINISM_CONTRACT.md",
    ...
    "docs/contracts/M4_EDIT_SPATIAL_INDEX_CONTRACT.md",
    "docs/contracts/M4_EDIT_JOURNAL_CONTRACT.md",
    "docs/contracts/M4_EDIT_APPLICATION_CONTRACT.md",
    "docs/contracts/M4_SNAPSHOT_COMPACTION_CONTRACT.md",
    "docs/contracts/M4_STORAGE_TOOLS_CONTRACT.md",
    "docs/contracts/M4_DENSE_BAKE_TOOL_CONTRACT.md",
    "docs/contracts/M4_EDITOR_BAKE_ENTRY_CONTRACT.md",
    "docs/contracts/M5_ASYNC_STORAGE_CONTRACT.md",
    "docs/contracts/M5_STORAGE_PAGE_CACHE_CONTRACT.md",
    "docs/contracts/M5_DERIVED_RESOURCE_CACHE_CONTRACT.md",
    "docs/contracts/M5_MULTI_VIEWER_DESIRED_SET_CONTRACT.md",
    "docs/contracts/M5_EDIT_RUNTIME_REPLACEMENT_CONTRACT.md",
    "docs/contracts/M5_REPRESENTATIVE_WORKLOAD_CONTRACT.md",
    "docs/contracts/M5_RUNTIME_BUDGET_CONTRACT.md",
    "docs/contracts/M5_PIPELINE_BUDGET_CONTRACT.md",
    ...
    "docs/contracts/PRODUCTION_CONFIGURATION_CONTRACT.md",
    "docs/contracts/PRODUCTION_LIFECYCLE_CONTRACT.md",
    ...
    "docs/contracts/PRODUCTION_RELEASE_CONTRACT.md",
    ...
    "tests/native/wt_production_world_fixture.h",
