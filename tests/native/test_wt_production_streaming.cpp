...
int main(int argc, char **argv) {
	...
	check(metrics.viewer_updates >= 4 && metrics.viewer_removals == 2 &&
		...
		// Player-support LOD0 collision shares the reserved deadline lane behind
		// committed edits, while ordinary cold streaming remains background work.
		...
		metrics.mesh_worker_interactive_queue_wait_ns_total >=
