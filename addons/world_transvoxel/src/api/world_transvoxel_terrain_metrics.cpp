...
godot::Dictionary WorldTransvoxelTerrain::get_runtime_metrics() const {
	...
	set_metric(
		output,
		"mesh_worker_interactive_lane_count",
		runtime.mesh_worker_interactive_lane_count
	);
	set_metric(
		output,
		"mesh_worker_interactive_accepted_jobs",
		runtime.mesh_worker_interactive_accepted_jobs
	);
	set_metric(
		output,
		"mesh_worker_interactive_started_jobs",
		runtime.mesh_worker_interactive_started_jobs
	);
	set_metric(
		output,
		"mesh_worker_interactive_completed_jobs",
		runtime.mesh_worker_interactive_completed_jobs
	);
	set_metric(
		output,
		"mesh_worker_interactive_queued_jobs",
		runtime.mesh_worker_interactive_queued_jobs
	);
	set_metric(
		output,
	...
	set_metric(output, "interaction_shell_refreshes",
		runtime.interaction_shell_refreshes);
	set_metric(output, "interaction_shell_added_chunks",
		runtime.interaction_shell_added_chunks);
	set_metric(output, "interaction_shell_rejections",
		runtime.interaction_shell_rejections);
	set_metric(output, "interaction_shell_planning_ns_max",
		runtime.interaction_shell_planning_ns_max);
